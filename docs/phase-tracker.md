...
| 9   | Copy & micro-UX                   | ⏳ Partial          | Blend profile section now uses COA link labels by default; still needs final copy and Trust Stack disclaimer (“Batch-specific; see COA for details.”).                |
