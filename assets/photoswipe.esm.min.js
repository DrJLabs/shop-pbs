...
class M {
  ...
  correctZoomPan(t) {
    ...
    let u = i({ x: 0, y: 0 }, p);
    (t &&
      ((this.A.x = 0), (this.A.y = 0), (this.T.x = 0), (this.T.y = 0), (this.I = o), i(this.C, p)),
...
class T {
          ...
          this.N
            ...
            : this.R
              ? (this.q('touch', 'start', 'end', 'cancel'),
                t.scrollWrap &&
                  ((t.scrollWrap.ontouchmove = () => {}), (t.scrollWrap.ontouchend = () => {})))
  ...
  j() {
    this.isDragging &&
      ((this.isDragging = !1), this.V || this.it(!0), this.drag.end(), (this.dragAxis = null));
  }
  onPointerUp(t) {
    this.F &&
      (this.K(t, 'up'),
...
class E {
  ...
  ft(t) {
    ...
    if (
      (function (t) {
        return (
          ('button' in t && 1 === t.button) || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey
        );
      })(t)
    )
      return;
...
class R {
  constructor(i, s) {
    ...
    let n = '';
    s.isButton
      ? ((n += 'pswp__button '), (n += s.className || `pswp__button--${s.name}`))
    ...
    let c = i.element;
    ('bar' === a
      ? (i.topBar || (i.topBar = t('pswp__top-bar pswp__hide-on-close', 'div', i.scrollWrap)),
        (c = i.topBar))
      : (r.classList.add('pswp__hide-on-close'), 'wrapper' === a && (c = i.scrollWrap)),
  ...
  q = {
    ...
    onInit: (t, i) => {
      ...
      const e = (i) => {
          var h, e;
          s !== i &&
            ((s = i), (h = 'active'), (e = i), t.classList.toggle('pswp__preloader--' + h, e));
        },
        n = () => {
...
class Y {
  ...
  setDisplayedSize(t, i) {
    if (
      ...
      !this.instance.dispatch('contentResize', { content: this, width: t, height: i })
...
class Q {
  ...
  getContentBySlide(t) {
    ...
    return (
      i || ((i = this.pswp.createContentFromData(t.data, t.index)), this.addToCache(i)),
      i.setSlide(t),
      i
    );
  }
      ...
      this.isOpening
        ? (this.kt
          ...
          this.$t &&
            (this.qt(),
            this.Bt &&
              ((this.Bt.style.willChange = 'transform'), (this.Bt.style.opacity = String(0.003)))))
        : this.isClosing &&
...
class st extends class extends class {
  ...
  getNumItems() {
    ...
    i && 'length' in i
      ...
      : i &&
        'gallery' in i &&
        (i.items || (i.items = this.Qt(i.gallery)), i.items && (t = i.items.length));
  ...
  getItemData(t) {
    ...
    Array.isArray(i)
      ? (s = i[t])
      : i && 'gallery' in i && (i.items || (i.items = this.Qt(i.gallery)), (s = i.items[t]));
    let h = s;
