...
class l {
  ...
  setDisplayedSize(t, s) {
    if (
      ...
      !this.instance.dispatch('contentResize', { content: this, width: t, height: s })
...
class m extends class extends class {
  ...
  getNumItems() {
    ...
    i && 'length' in i
      ...
      : i &&
        'gallery' in i &&
        (i.items || (i.items = this.m(i.gallery)), i.items && (t = i.items.length));
  ...
  getItemData(t) {
    ...
    Array.isArray(i)
      ? (s = i[t])
      : i && 'gallery' in i && (i.items || (i.items = this.m(i.gallery)), (s = i.items[t]));
    let h = s;
