...
class SwiperContainer extends ClassToExtend {
  ...
  initialize() {
    ...
    ((this.swiperParams = i),
      ...
      (this.swiper = new Swiper(this.shadowRoot.querySelector('.swiper'), {
        ...(i.virtual ? {} : { observer: !0, observeSlideChildren: this.slideSlots > 0 }),
        ...i,
        touchEventsTarget: 'container',
        onAny: function (t) {
          'observerUpdate' === t && e.calcSlideSlots();
          const r = i.eventsPrefix ? `${i.eventsPrefix}${t.toLowerCase()}` : t.toLowerCase();
          for (var s = arguments.length, a = new Array(s > 1 ? s - 1 : 0), n = 1; n < s; n++)
            a[n - 1] = arguments[n];
          const o = new CustomEvent(r, { detail: a, bubbles: 'hashChange' !== t, cancelable: !0 });
          e.dispatchEvent(o);
        },
      })));
  }
  ...
  updateSwiperOnPropChange(e, i) {
    const { params: t, passedParams: r } = getParams(this, e, i);
    ((this.passedParams = r),
      (this.swiperParams = t),
      (this.swiper && this.swiper.params[e] === i) ||
        updateSwiper({
          ...
          ...('navigation' === e && r[e]
            ...
            : {}),
          ...('pagination' === e && r[e] ? { paginationEl: '.swiper-pagination' } : {}),
          ...('scrollbar' === e && r[e] ? { scrollbarEl: '.swiper-scrollbar' } : {}),
        }));
  }
  attributeChangedCallback(e, i, t) {
    this.initialized &&
      ('true' === i && null === t && (t = !1), this.updateSwiperOnPropChange(e, t));
  }
