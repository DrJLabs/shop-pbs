class DrawerSearchSection extends HTMLElement {
  constructor() {
    ...
    this.triggerQuery = ['.wt-header__search-trigger', '.wt-header__search__close'].join(', ');
    ...
    this.saveSuggestionMenuInDesignMode = this.saveSuggestionMenuInDesignMode.bind(this);
  ...
  setupEventListeners() {
    ...
    if (Shopify.designMode) {
      document.addEventListener('shopify:section:load', this.saveSuggestionMenuInDesignMode);
    }
  }
