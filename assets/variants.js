    ...
    class VariantOptions extends HTMLElement {
      ...
      onVariantChange() {
        ...
        if (!this.currentVariant) {
          ...
          this.updateMedia();
          this.lenOfVariantOptions = document.querySelectorAll('variant-options').length;
      ...
      updateOptions() {
        const fieldsets = Array.from(this.querySelectorAll('.wt-product__option'));
        ...
        fieldsets.forEach((fieldset, index) => {
          ...
          fieldset.querySelector('.wt-product__option__title .value').innerHTML = selectedOption;
          const dropdown = fieldset.querySelector('.wt-product__option__dropdown span');
      ...
      updateMedia() {
        ...
        this.setAttribute('data-featured-image-id', this.currentVariant?.featured_media?.id);
