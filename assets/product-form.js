  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      ...
      closeComplementaryProduct() {
        const complementaryOverlayPage = document.querySelector('.wt__quick-buy--page-overlay');
        if (this.body.classList.contains('quick-buy-page-overlay'))
          this.body.classList.remove('quick-buy-page-overlay');
        if (complementaryOverlayPage.classList.contains('wt__quick-buy--page-overlay--open'))
          complementaryOverlayPage.classList.remove('wt__quick-buy--page-overlay--open');
      }
      ...
      onSubmitHandler(evt) {
        ...
        fetch(`${routes.cart_add_url}`, config)
          ...
          .finally(() => {
            ...
            this.quick_add_product = this.quick_add_container.querySelector('.wt-product');
            this.loader = this.quick_add_container.querySelector('.wt__quick-buy-loader');
