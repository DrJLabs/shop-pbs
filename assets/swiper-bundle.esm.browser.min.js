...
function getTranslate(e, t = 'x') {
  ...
  return (
    ...
    'y' === t &&
      (i = s.WebKitCSSMatrix ? r.m42 : 16 === a.length ? parseFloat(a[13]) : parseFloat(a[5])),
    i || 0
  );
}
function isObject(e) {
...
function updateSize() {
  ...
  ((t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : a[0].clientWidth),
    ...
    (0 === t && e.isHorizontal()) ||
      ...
      (s =
        s - parseInt(a.css('padding-top') || 0, 10) - parseInt(a.css('padding-bottom') || 0, 10)),
      Number.isNaN(t) && (t = 0),
      Number.isNaN(s) && (s = 0),
  ...
  if (((c = a && e > o ? o : a && e < d ? d : e), r.updateProgress(c), n.cssMode)) {
    ...
    if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
      ...
      if (!r.support.smoothScroll)
        return (
          animateCSSModeScroll({ swiper: r, targetPosition: -c, side: e ? 'left' : 'top' }),
          !0
        );
...
function slideTo(e = 0, t = this.params.speed, s = !0, a, i) {
  ...
  if (l.cssMode) {
    ...
    if (0 === t) {
      ...
      if (!r.support.smoothScroll)
        return (
          animateCSSModeScroll({ swiper: r, targetPosition: s, side: e ? 'left' : 'top' }),
          !0
        );
...
function onTouchStart(e) {
  ...
  if (
    ((i.isTouchEvent = 'touchstart' === o.type), !i.isTouchEvent && 'which' in o && 3 === o.which)
  )
    return;
...
function onTouchMove(e) {
  ...
  const d =
      'touchmove' === o.type && o.targetTouches && (o.targetTouches[0] || o.changedTouches[0]),
  ...
  if (
    (a.allowTouchCallbacks && s.emit('touchMove', o), o.targetTouches && o.targetTouches.length > 1)
  )
    return;
  ...
  if (
    ...
    void 0 === a.startMoving &&
      ((r.currentX === r.startX && r.currentY === r.startY) || (a.startMoving = !0)),
    a.isScrolling)
  )
  ...
  if (
    ...
    m > 0 && a.currentTranslate > s.minTranslate()
      ? ((f = !1),
        i.resistance &&
          (a.currentTranslate =
            s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + m) ** g))
      : m < 0 &&
        a.currentTranslate < s.maxTranslate() &&
        ((f = !1),
        i.resistance &&
          (a.currentTranslate =
            s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - m) ** g)),
  ...
  function u(t) {
    ...
    if (
      ...
      if (
        (o.push(s),
        a
          ? (s.direction !== a.direction || s.delta > a.delta || s.time > a.time + 150) && p(s)
          : p(s),
        (function (t) {
    ...
    e.params.createElements &&
      Object.keys(a).forEach((r) => {
        if (!s[r] && !0 === s.auto) {
          ...
          (n || ((n = i.createElement('div')), (n.className = a[r]), e.$el.append(n)),
            (s[r] = n),
            (t[r] = n));
        }
      }),
  ...
  function p() {
    ...
    0 !== s.length &&
      (e.params.uniqueNavElements &&
        ...
        s.length > 1 &&
        ((s = e.$el.find(t.el)),
        s.length > 1 && (s = s.filter((t) => $(t).parents('.swiper')[0] === e.el))),
...
function Scrollbar({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  function h() {
    ...
    ((s[0].style.width = ''),
      ...
      (n =
        'auto' === e.params.scrollbar.dragSize ? l * o : parseInt(e.params.scrollbar.dragSize, 10)),
  ...
  function f(t) {
    ...
    let o;
    ((o =
      (m(t) - i.offset()[e.isHorizontal() ? 'left' : 'top'] - (null !== r ? r : n / 2)) / (l - n)),
  ...
  function x() {
    ...
    (0 === r.length &&
      ((r = $(`<div class="${e.params.scrollbar.dragClass}"></div>`)), i.append(r)),
...
function Autoplay({ swiper: e, extendParams: t, on: s, emit: a }) {
  ...
  ((e.autoplay = { running: !1, paused: !1 }),
    ...
    s('beforeTransitionStart', (t, s, a) => {
      e.autoplay.running &&
        (a || !e.params.autoplay.disableOnInteraction ? e.autoplay.pause(s) : l());
    }),
    s('sliderFirstMove', () => {
...
function Thumb({ swiper: e, extendParams: t, on: s }) {
  ...
  function r() {
    ...
    let i;
    if (
      ((i = t.params.loop ? parseInt($(t.clickedSlide).attr('data-swiper-slide-index'), 10) : s),
      e.params.loop)
    ) {
      let t = e.activeIndex;
      ...
      for (let e = 0; e < a.length; e += 1) {
        ...
        if (
          ...
          (0 === e.length &&
            ...
            0 === s.length &&
              ((s = $(`<div class="swiper-slide-shadow-${c ? 'right' : 'bottom'}"></div>`)),
              t.append(s)),
...
function createShadow(e, t, s) {
  ...
  return (
    r.length ||
      ((r = $(`<div class="swiper-slide-shadow${s ? `-${s}` : ''}"></div>`)), i.append(r)),
    r
  );
}
