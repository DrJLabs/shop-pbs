  ...
  customElements.define(
    ...
    class VariantDropdown extends HTMLElement {
      constructor() {
        ...
        this.dropdownButton = this.querySelector('.wt-product__option__dropdown');
        ...
        this.isInsideFeaturedProductSection = this.featuredProductSection !== null;
        this.featuredProductSectionActiveClass = 'wt-featured-product--active-variant-dropdown';
      ...
      openDrawer() {
        ...
        if (this.isInsideFeaturedProductSection) {
          this.featuredProductSection.classList.add(this.featuredProductSectionActiveClass);
        }
      ...
      closeDrawer() {
        ...
        this.isDrawerOpen = false;
        if (this.isInsideFeaturedProductSection) {
          this.featuredProductSection.classList.remove(this.featuredProductSectionActiveClass);
        }
        this._handleTabindex();
      ...
      handleInteractionOutside(event) {
        if (this.isDrawerOpen) {
          ...
          if ((!clickInsideDrawer && event.target !== this.dropdownButton) || clickOption) {
            this.closeDrawer();
          }
        }
      }
      ...
      getFocusableElements() {
        ...
        const focusableElements = () =>
          Array.from(this.container.querySelectorAll(focusableElementsSelector)).filter(
