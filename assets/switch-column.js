  ...
  customElements.define(
    ...
    class SwitchColumn extends HTMLElement {
      ...
      addEventListeners() {
        ...
        this.sortCustomSelect.addEventListener('wtSelectChange', this.boundHandleLoad);
        this.container.addEventListener('click', this.boundChangeNumberOfColumns);
      }
      ...
      removeEventListeners() {
        ...
        this.container.removeEventListener('click', this.boundChangeNumberOfColumns);
        this.sortCustomSelect.removeEventListener('wtSelectChange', this.boundHandleLoad);
      }

      handleLoad() {
        this.loader.classList.add('loading-overlay--hidden');
        this.container.classList.remove('collection__mobile-layout-switch--hidden');
      ...
      handleResize() {
        if (
          ...
          if (this.container.classList.contains('collection__mobile-layout-switch--hidden')) {
            this.container.classList.remove('collection__mobile-layout-switch--hidden');
          }
          this.setNumberOfColumns();
        }
      ...
      getNumberOfColumns() {
        if (this.dataset.designMode === 'true') {
          ...
          const value = valueFromLocalStorage !== null ? valueFromLocalStorage : this.dataset.col;
          return value;
        }
      }
